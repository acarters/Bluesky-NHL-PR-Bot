...
export default async function getPostText() 
{
	...
	var awaitTweet = await mastodon.getStatuses("110730189075250259", {'limit':limitVal}); //Use the Mastodon API to get a specified number of recent posts from the Mastodon API.
